...
<body>
    ...
    <header>
        ...
        switch ($info) {
            ...
            <img class="Mercenary" src="../Media/Heavy.jpg" alt="Soldier" width="500px">
            <img class="title" src="../Media/ScoutTitle.png" alt="Title" width="500px">
            HEAVY; break;
        }
        ?>
            ...
            if (isset($_GET['class'])) {
                ...
                switch ($info) {
                    ...
                    case 'heavy': echo <<< HEAVY
                        ...
                        <img src="https://wiki.teamfortress.com/w/images/4/44/Heavy_contract_drawer.png" alt="Soldier" height="260px" style="position: absolute; right: -200px; top: 100px;" class="shadow">
                        <p>
                        ...
                        <img src="https://wiki.teamfortress.com/w/images/5/5d/Merch_Heavy_Portrait.png" alt="SoldierAndDemo" height="260px" style="position: absolute; left: -200px; top: 280px; transform: rotate(10deg);" class="shadow">
